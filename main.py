...
print("There people can be government, nations, companies, community organizations, and individuals.\n")


#Introduces CIA Triad
print("The CIA Triad is the model used to discuss cybersecurity. CIA stands for confidentiality, integrity, and availabilty")
